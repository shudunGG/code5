...
public class GfChnlListLabel extends ABaseLabel {

    public GfChnlListLabel(String xml) {
        super(xml,"GF_CHNLLIST");
    }

    /**
     * GF_CHNLLIST
     *         <GF_CHNLLIST [ID=””][NAME=”栏目名”][SPECIAL_CHANNEL_ID=”栏目唯一标识”][SITEID="站点 ID"][CHANNELID="栏目ID"] [CHILDINDEX=”子栏目序号”]
     *         [STARTPOS=”起始位置”] [CHNLIDS=”多个栏目ID用英文逗号分隔”]
     * [NUM=”数目”][CHILDTYPE=”所取子栏目的类型”] [PAGESIZE=”分页参数”]> <column_block> </GF_CHNLLIST>
     * @return
     */
    public String getLabelHtmlContent(BaseService baseService) throws  Exception {
         ...
         */
        //现在需要对channelList展示，实现对GF_CHNLLIST置标内部的内容做循环，同时检测到GF_CHANNEL后，调用置标
        String s = this.mylabel.substring(this.mylabel.indexOf(">")+1,this.mylabel.indexOf("</GF_CHNLLIST>"));
        //处理子标签
