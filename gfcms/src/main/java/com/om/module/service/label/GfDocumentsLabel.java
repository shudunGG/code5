...
/**
 * @deprecated 被GfDocListLabel替换，因为置标GF_DOCUMENTS和GF_DOCUMENT在名称上太像了，导致字符串截取时bug较多
 * modiby liuxj@20240321
 */
public class GfDocumentsLabel extends ABaseLabel {

    public GfDocumentsLabel(String xml) {
        super(xml,"GF_DOCUMENTS");
    }
    ...
    /**
     * GF_DOCUMENTS
     *         <GF_DOCUMENTS [[NAME=”栏目名称”][ID=”栏目ID”] [CHILDINDEX=”子栏目的序号”]
    ...
    public String getLabelHtmlContent(BaseService baseService) throws  Exception {
        ...
        String s = this.mylabel.substring(this.mylabel.indexOf(">")+1,this.mylabel.indexOf("</GF_DOCUMENTS>"));
        //处理子标签
    ...
    public void ruleCheck(BaseService baseService)throws Exception{
        ...
        if(GROUP_NUM != null && GROUP_MACRO_DEFINE == null
           ...
           GROUP_NUM == null && GROUP_MACRO_DEFINE != null
            ...
            throw new Exception("GROUP_NUM和GROUP_MACRO_DEFINE属性，在置标GF_DOCUMENTS必须成对出现");
        }
