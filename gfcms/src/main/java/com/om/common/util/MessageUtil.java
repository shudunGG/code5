...
import com.om.bo.message.req.TextMessage;
import com.om.bo.message.resp.Article;
import com.om.bo.message.resp.MusicMessage;
		...
		for (Element e : elementList){
			...
			if(subElementList == null||subElementList.size() == 0){
				...
				for (Element subE : subElementList){
					map.put(e.getName()+"."+subE.getName(),subE.getText());
				}
			}
