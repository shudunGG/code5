...
* @Version:        1.0
*/
public class SupervisionPhaseReportChiWrapper extends BaseEntityWrapper<SupervisionPhaseReportChi, SupervisionPhaseReportChiVO> {

	public static SupervisionPhaseReportChiWrapper build(){
		return new SupervisionPhaseReportChiWrapper();
	}

	@Override
	public SupervisionPhaseReportChiVO entityVO(SupervisionPhaseReportChi entity) {
		SupervisionPhaseReportChiVO vo = Objects.requireNonNull(BeanUtil.copy(entity,SupervisionPhaseReportChiVO.class));
