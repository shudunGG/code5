...
* @Version:        1.0
*/
public class SupervisionPhaseReportWrapper extends BaseEntityWrapper<SupervisionPhaseReport, SupervisionPhaseReportVO> {

	public static SupervisionPhaseReportWrapper build(){
		return new SupervisionPhaseReportWrapper();
	}

	@Override
	public SupervisionPhaseReportVO entityVO(SupervisionPhaseReport entity) {
		SupervisionPhaseReportVO vo = Objects.requireNonNull(BeanUtil.copy(entity,SupervisionPhaseReportVO.class));
