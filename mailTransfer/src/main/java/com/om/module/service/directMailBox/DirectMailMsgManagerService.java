package com.om.module.service.directMailBox;
...
@Service("DirectMailMsgManagerService")
public class DirectMailMsgManagerService extends CommonService {
    ...
    public List queryBusiAppMailMsg(Map param) throws Exception {
        ...
        List list = this.baseService.getList("busiMapper"+ Dict.dbMap+".queryBusiAppMailMsgDirect",param);
        return list;
    }
     ...
     * @throws Exception
     */
    public Map queryBusiAppMailMsgById(Map param) throws Exception {
        String MSG_PK = (String)param.get("MSG_PK");
        this.isNull("MSG_PK",MSG_PK);
        Map map = (Map)this.baseService.getObject("busiMapper"+ Dict.dbMap+".queryBusiAppMailMsgById",param);
        return map;
    }
}
