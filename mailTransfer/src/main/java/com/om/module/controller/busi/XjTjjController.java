...
import com.om.module.service.busi.XjTjjService;
...
@Controller
@RequestMapping("/busi")
public class XjTjjController extends BaseCtrl {
    protected Logger logger = LoggerFactory.getLogger(XjTjjController.class);
    @Resource(name = "XjTjjService")
    private XjTjjService service;
